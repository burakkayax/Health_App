...
fun SupplementTemplateEntity.toDomain(): SupplementTemplate = SupplementTemplate(
    id = id,
    name = name,
...
fun SupplementDoseEntryEntity.toDomain(): SupplementDoseEntry = SupplementDoseEntry(
    id = id,
...
fun SupplementDoseEntry.toEntity(): SupplementDoseEntryEntity = SupplementDoseEntryEntity(
    id = id,
    templateId = templateId,
    date = date,
    amount = amount,
...
fun createSupplementTemplatesFromNames(names: List<String>): List<SupplementTemplate> = names.mapIndexed { index, name ->
