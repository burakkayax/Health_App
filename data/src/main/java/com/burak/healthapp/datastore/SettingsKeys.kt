...
object SettingsKeys {
    ...
    val dailyCaffeineLimitMg = intPreferencesKey("daily_caffeine_limit_mg")
    val caffeineCutoffTime = stringPreferencesKey("caffeine_cutoff_time")
    val caffeineSleepBufferHours = intPreferencesKey("caffeine_sleep_buffer_hours")
    ...
    val waterReminderSnoozedDate = stringPreferencesKey("water_reminder_snoozed_date")
    val stepTrackingEnabled = booleanPreferencesKey("step_tracking_enabled")
    val dashboardCardConfig = stringPreferencesKey("dashboard_card_config")
