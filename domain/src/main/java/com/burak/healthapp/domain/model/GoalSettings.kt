...
data class GoalSettings(
    ...
    val dailyCaffeineLimitMg: Int = DefaultHealthGoals.DAILY_CAFFEINE_LIMIT_MG,
    val caffeineCutoffTime: LocalTime = DefaultHealthGoals.CAFFEINE_CUTOFF_TIME,
    val caffeineSleepBufferHours: Int = DefaultHealthGoals.CAFFEINE_SLEEP_BUFFER_HOURS,
